...
class MSMT17(Dataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        query = self.process_dir(self.test_dir, self.list_query_path,'query')
        gallery = self.process_dir(self.test_dir, self.list_gallery_path,'gallery')
    ...
    def process_dir(self, dir_path, list_path,type_dataset):
        ...
        for img_idx, img_info in enumerate(lines):
            ...
            src_path = img_path
            dst_path = osp.join(save_path,im_path)
...
if __name__ =='__main__':
    root = '/homes/ss014/projects/FedReID-master/sourceDataset/msmt17/pytorch'
    dataset = MSMT17(root=root)
