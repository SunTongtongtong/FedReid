...
def _resnet(arch, inplanes, planes, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ckp_path = '/import/sgg-homes/ss014/project/BMVC_model/resnet-50-an-imagenet-200e-lbsmth-mixup/model_best.pth.tar'
    
        checkpoint = torch.load(ckp_path, map_location='cpu')

        state_dict = {k[15:]: v for k, v in checkpoint['state_dict'].items()}
