...
class GRID(BaseImageDataset):
    ...
    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        ...
        self.probe_path = osp.join(self.dataset_dir, 'probe')
        self.gallery_path = osp.join(self.dataset_dir, 'gallery')
        self.split_mat_path = osp.join(self.dataset_dir, 'features_and_partitions.mat')
