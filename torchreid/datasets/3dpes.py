...
class VIPeR(BaseImageDataset):
    ...
    def __init__(self, root='data', split_id=1, verbose=True, **kwargs):
        ...
        self._prepare_split()
        splits = read_json(self.split_path) # including 20 splits, used to evaluate average on them
        #split  len = 20, each with key: train, gallery query etc
    ...
    def _prepare_split(self):
        if not osp.exists(self.split_path):
            ...
            imgs = sorted(glob.glob(osp.join(self.cam_a_path, '*.bmp')))
